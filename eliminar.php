...
<section class="container-fluid">
 <h3 class="titulo">Eliminar Productos</h3>
		  ...
		  $resultado1 = $conexion->query($sql);
		   while($row = $resultado1->fetch_array(MYSQLI_ASSOC) ) { 
			...
			<tr>
			 ...
			 <td><a href="confirmaciondelete.php?id=<?php echo $row['id']; ?>" style="color: rgba(255,0,4,1.00)"><span class="glyphicon glyphicon-eye-close"></span></a></td>	
		 </tr>  
		<?php  } ?> 
