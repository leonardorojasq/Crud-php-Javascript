...
<!----------------------------------------FIN MENU--------------------------------------------->
<h1 class="titulo">Crear Tabla</h1>
<div class="bdcreada">
	<?php
	$servidor = "localhost";
	$nombreusuario = "root";
	...
	$conexion = new mysqli($servidor, $nombreusuario, $password, $database );
		...
		$sql = "CREATE TABLE IF NOT EXISTS `tabla46` (
		...
		if($conexion->query($sql) === true){
			echo "  ";
			echo "<font color='green'>"."Creación de tabla existosa.!"."</font>";
		}else{
			die("<font color='green'>"."La tabla ya creada!"."</font>" . $conexion->connect_error);
		}
	?>
  </div>		
<!--  Bootstrap JS -->
